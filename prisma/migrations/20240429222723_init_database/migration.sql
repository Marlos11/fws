...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_categiryId_fkey" FOREIGN KEY ("categiryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
